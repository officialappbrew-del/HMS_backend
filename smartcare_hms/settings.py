...
# EMAIL SETTINGS
# ============================================
EMAIL_DELIVERY_MODE = config('EMAIL_DELIVERY_MODE', default='async').lower()
if EMAIL_DELIVERY_MODE not in {'async', 'sync'}:
    raise ValueError("EMAIL_DELIVERY_MODE must be either 'async' or 'sync'.")
