...
from .views import (
    ...
    CommunicationProfileViewSet, ExternalServiceProfileViewSet, TenantSupportTicketViewSet,
...
router.register(r'external-services', ExternalServiceProfileViewSet, basename='external-service-profile')
